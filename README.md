...
- **SONAR_HOST_URL**       : SonarQube Server Host URL [🔗](https://github.com/Yashtank-git/java-maven-sonar-argocd-gh_actions-k8s/yashtank/dev/README.md#setting-up-sonarqube) 
- **SONAR_TOKEN**          : SonarQube User Security Token to Sonar Scan [🔗](https://github.com/Yashtank-git/java-maven-sonar-argocd-gh_actions-k8s/yashtank/dev/README.md#setting-up-sonarqube) 
